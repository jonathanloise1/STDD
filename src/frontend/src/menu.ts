...
// COMPANY PAGES MENU
/** @userstory US-MENU-01, US-MENU-02, US-MENU-04, US-MENU-05 */
export const companyPagesMenu = {
	dashboard: {
		id: 'company-dashboard',
		text: 'Dashboard',
		path: 'dashboard',
		icon: 'Dashboard',
		iconColorClass: 'nav-c-blue',
		subMenu: null,
	},
	// ── Audit ────────────────────────────────────────────────────────
	auditLog: {
		id: 'company-audit-log',
		text: 'menu.auditLog',
		path: 'audit',
		icon: 'History',
		iconColorClass: 'nav-c-gray',
		adminOnly: true,
		subMenu: null,
	},
	// SETTINGS (Admin only) - Entry point to settings area
	Settings: {
		id: 'company-settings',
		text: 'Settings',
...
/** @userstory US-MENU-04, US-MENU-05, US-MENU-06 */
// All items are flat direct links (no sub-menus) for streamlined navigation.
// Master Agreement permanently removed — Legal confirmed T&C are sufficient.
export const settingsMenu = {
	organization: {
		id: 'company-settings-organization',
		text: 'settings.organization',
		path: 'settings/organization',
		icon: 'Business',
		iconColorClass: 'nav-c-blue',
		subMenu: null,
	...
	team: {
		id: 'company-settings-team',
		text: 'settings.team',
		path: 'settings/team',
		icon: 'Groups',
		iconColorClass: 'nav-c-amber',
		subMenu: null,
	},
};

// ── Tasks Domain Menu ─────────────────────────────────────────
// Used by SlimSidebar (desktop) and BottomTabBar (mobile) for task navigation.
