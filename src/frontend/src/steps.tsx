	...
	return (
		<div className='row'>
			<div className='col-md-5'>
				<img src={SusyDarkMode} style={imageStyle} width='100%' alt='' />
			</div>
	...
	return (
		<div className='row'>
			<div className='col-md-4'>
				<img src={Susy2} style={imageStyle} width='100%' alt='' />
			</div>
...
const SearchTour = () => {
	...
	return (
		<div className='row'>
			<div className='col-md-4'>
				<img src={Susy7} style={imageStyle} width='100%' alt='' />
			</div>
			<div className='col-md-8 d-flex align-items-center'>
				<div>
...
const CrmTour = () => {
	...
	return (
		<div className='row'>
			<div className='col-md-4'>
				<img src={Susy8} style={imageStyle} width='100%' alt='' />
			</div>
			<div className='col-md-8 d-flex align-items-center'>
				<div>
...
const DateRangeTour = () => {
	...
	return (
		<div className='row'>
			...
			<div className='col-md-4'>
				<img src={Susy3} style={imageStyle} width='100%' alt='' />
			</div>
			<TourNavigation />
		</div>
	);
...
const ListPageTour = () => {
	...
	return (
		<div className='row'>
			<div className='col-md-4'>
				<img src={Susy5} style={imageStyle} width='100%' alt='' />
			</div>
			<div className='col-md-8 d-flex align-items-center'>
				<div>
...
const EditPageTour = () => {
	...
	return (
		<div className='row'>
			<div className='col-md-4'>
				<img src={Susy6} style={imageStyle} width='100%' alt='' />
			</div>
			<div className='col-md-8 d-flex align-items-center'>
				<div>
...
const AuthPageTour = () => {
	...
	return (
		<div className='row'>
			<div className='col-md-4'>
				<img src={Susy4} style={imageStyle} width='100%' alt='' />
			</div>
			<div className='col-md-8 d-flex align-items-center'>
				<div>
...
const SalesTour = () => {
	...
	return (
		<div className='row'>
			<div className='col-md-4'>
				<img src={Susy} style={imageStyle} width='100%' alt='' />
			</div>
			<div className='col-md-8 d-flex align-items-center'>
				<div>
...
const DocTour = () => {
	...
	return (
		<div className='row'>
			<div className='col-md-4'>
				<img src={Susy9} style={imageStyle} width='100%' alt='' />
			</div>
			<div className='col-md-8 d-flex align-items-center'>
				<div>
...
const LastTour = () => {
	...
	return (
		<div className='row'>
			<div className='col-md-4'>
				<img src={Susy10} style={imageStyle} width='100%' alt='' />
			</div>
			<div className='col-md-8 d-flex align-items-center'>
				<div>
