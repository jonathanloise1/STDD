        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FiscalCode = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    BillingAddress = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    BillingCity = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    BillingProvince = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    BillingZipCode = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    BillingCountryCode = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLog_OrgId_Timestamp",
                table: "AuditLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Organization_VatNumber",
                table: "Organizations",
                column: "VatNumber");

            migrationBuilder.CreateIndex(
                name: "IX_OrganizationUser_Email_OrganizationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskItem_Org_AssignedTo",
                table: "TaskItems",
                columns: new[] { "OrganizationId", "AssignedToUserId" });

            migrationBuilder.CreateIndex(
                name: "IX_TaskItem_Org_Status",
                table: "TaskItems",
